...
public class MainScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(textRenderer, Text.literal("Version 0.2.0-hotfix.2").formatted(Formatting.GRAY), width / 2 - textRenderer.getWidth(Text.literal("Version 0.2.0-hotfix.2")) / 2, height / 2 + translationDev + 26, 0xFFFFFF, true);
    }
