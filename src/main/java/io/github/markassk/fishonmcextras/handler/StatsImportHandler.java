...
public class StatsImportHandler {
    ...
    private void getData(MinecraftClient minecraftClient) {
        ...
        if(fishCaught.get() != -1) {
            ...
            dummyProfileData.fishSizeDryStreak.put(Constant.BABY, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.BABY, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.fishSizeDryStreak.put(Constant.JUVENILE, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.JUVENILE, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.fishSizeDryStreak.put(Constant.ADULT, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.ADULT, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.fishSizeDryStreak.put(Constant.LARGE, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.LARGE, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.fishSizeDryStreak.put(Constant.GIGANTIC, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.GIGANTIC, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.variantDryStreak.put(Constant.ALBINO, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.ALBINO, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.variantDryStreak.put(Constant.MELANISTIC, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.MELANISTIC, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.variantDryStreak.put(Constant.TROPHY, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.TROPHY, oldProfileData.allFishCaughtCount)), fishCaught.get()));
            dummyProfileData.variantDryStreak.put(Constant.FABLED, Math.min(fishCaught.get() - (oldProfileData.allFishCaughtCount - oldProfileData.rarityDryStreak.getOrDefault(Constant.FABLED, oldProfileData.allFishCaughtCount)), fishCaught.get()));
